...
impl GroundModeContext {
    ...
    /// - [`SpecialProcessId::SPECIAL_PROC_ADD_ITEM_TO_BAG`] : [`gameplay::script_special_process_add_item_to_bag`]
    /// - [`SpecialProcessId::SPECIAL_PROC_0x39`] : [`gameplay::script_special_process_0x39`]
    /// - [`SpecialProcessId::SPECIAL_PROC_COUNT_ITEM_TYPE_IN_STORAGE`] : [`gameplay::script_special_process_count_item_type_in_storage`]
    /// - [`SpecialProcessId::SPECIAL_PROC_0x2A`] : [`gameplay::script_special_process_remove_items_type_in_storage`]
    /// - [`SpecialProcessId::SPECIAL_PROC_ADD_ITEM_TO_STORAGE`] : [`gameplay::script_special_process_add_item_to_storage`]
