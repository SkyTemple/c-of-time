...
impl GroundModeContext {
    ...
    /// - [`SPECIAL_PROC_0x3A`] : [`gameplay::increment_number_dungeons_cleared`]
    /// - [`SPECIAL_PROC_0x3B`] : [`gameplay::increment_number_of_big_treasure_wins`]
    /// - [`SPECIAL_PROC_SEND_SKY_GIFT_TO_GUILDMASTER`] : [`gameplay::increment_number_of_gifts_sent`]
